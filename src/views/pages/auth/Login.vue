            ...
            <div
                ...
                <div class="w-full surface-card py-8 px-5 sm:px-8" style="border-radius: 53px">
                    <div class="text-center mb-5">
                        ...
                        <div class="text-900 text-3xl font-medium mb-3">Welcome to <span class="text-primary">Soft 4
                                You</span> MS</div>
                    ...
                    <div>
                        ...
                        <div class="flex align-items-center justify-content-between mb-5 gap-5">
                            ...
                            <a class="font-medium text-primary no-underline ml-2 text-right cursor-pointer">Forgot
                                password?</a>
                        </div>
