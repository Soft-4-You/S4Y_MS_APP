        ...
        <div class="col-12">
            <div class="card">
                ...
                >
                    ...
                    <Column header="Comment" filterField="representative" :showFilterMatchModes="false" :filterMenuStyle="{ width: '14rem' }" style="min-width: 16rem">
                        <template #body="{ data }">
                    ...
                    <!-- <Column field="status" header="Importance" :filterMenuStyle="{ width: '14rem' }" style="min-width: 12rem">
                        <template #body="{ data }">
